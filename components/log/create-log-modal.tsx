      ...
      <ResponsiveDialogContent>
        ...
        <ResponsiveDialogBody className="space-y-4 overflow-y-auto pb-4">
          ...
          {showActivitySelector && (
            <div>
              <Label className="text-muted-foreground text-xs mb-1 block tracking-wide uppercase">活動を選ぶ</Label>
          ...
          {/* Date + Time */}
          <div>
            <Label className="text-muted-foreground text-xs mb-1 block tracking-wide uppercase">日時</Label>
          ...
          {/* Memo */}
          <div>
            <Label htmlFor="create-log-note" className="text-muted-foreground text-xs mb-1 block tracking-wide uppercase">
              メモ
            </Label>
            <Textarea
              id="create-log-note"
