...
export default function ChangePasswordCard() {
  ...
  return (
    <section className="space-y-3">
      <h2 className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">パスワード</h2>
      <div className="bg-card rounded-xl p-4 space-y-4">
        <div className="space-y-1">
          <p className="text-sm font-medium text-foreground">パスワード変更</p>
          <p className="text-xs text-muted-foreground">ログインに使用するパスワードを変更できます</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div className="space-y-1">
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-muted text-sm text-foreground rounded-lg px-3 py-2 pr-9 border border-border focus:outline-none focus:border-primary/50 placeholder:text-muted-foreground/50"
              />
              <button
                type="button"
          ...
          <label className="flex items-center gap-2 cursor-pointer select-none">
            ...
            />
            <span className="text-xs text-muted-foreground">他の端末からログアウトする</span>
          </label>

          <button
            type="submit"
            disabled={loading}
            className="w-full py-2 rounded-lg text-sm font-medium bg-primary text-primary-foreground hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
